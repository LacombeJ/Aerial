...
public class Image extends Array2Di {
    ...
    public Image subImage(int i, int j, int width, int height) {
    ...
    public Image quadrant(int i, int j) {
        int width = getRows()/2;
    ...
    public Image halfImage() {
        Image image = new Image(getRows()/2,getColumns()/2);
