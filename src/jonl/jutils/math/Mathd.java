...
public final class Mathd {
    ...
    public static final double THREE_PI_OVER_4      = PI*3/4;
    public static final double FIVE_PI_OVER_4       = PI*5/4;
    public static final double THREE_PI_OVER_2      = PI*3/2;
    public static final double SEVEN_PI_OVER_4      = PI*7/4;
    public static final double TWO_PI               = PI*2;
    public static final double TWO_PI_OVER_3        = PI*2/3;
